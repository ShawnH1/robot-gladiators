...
var fight = function (enemyName) {
  while (playerHealth > 0 && enemyHealth > 0) {
    ...
    if (promptFight .toLowerCase() !== "skip" || promptFight .toLowerCase() !== "fight" ){
      window.alert("Please type 'skip' or 'fight'.")
      // Note: the player will skip a round as a penalty for not typing in "fight" or "skip" as previously requested
      // Note (continued): I may edit this to be penalty to playerMoney instead later.
      break;
    }
